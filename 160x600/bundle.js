    ...
    init: function init() {
      ...
      function display() {
        ...
        function animation() {
          ...
          tl.from("#txt_1b", 1, {
            autoAlpha: 0
          }).staggerFrom(["#txt_4", "#txt_5", "#txt_6"], 1, {
            autoAlpha: 0,
            ease: 'sine.in'
          }, 0.2, '-=0.5').add("animate").to(["#txt_1b,#txt_4,#txt_5,#txt_6"], 1, {
            autoAlpha: 0
          }, '+=1.5').to('#animation', {
            duration: 1,
            x: 10,
            ...
            repeat: 1,
            repeatDelay: 1.3
          }, '-=2.5').staggerFrom(["#txt_7", "#txt_8"], 1, {
            autoAlpha: 0,
            ease: 'sine.in'
          }, 0.2, '-=1.2') // .staggerFrom(["#txt_1,#txt_2,#txt_3","#txt_4","#txt_5","#txt_6"],1,{autoAlpha:0},0.2)
          .from("#pack_1", 0.5, {
            autoAlpha: 0
          }, '-=0.2').to("#pack_1", 0.5, {
            scale: 1.11,
            ...
            repeat: 1,
            repeatDelay: 1.3
          }, "animate"); // .staggerFrom(["#txt_1","#txt_2","#txt_3"],0.5,{autoAlpha:0,ease: 'sine.in'},0.2)
          // .add("animate")
          //
          // .to(["#txt_1,#txt_2,#txt_3"],0.5,{autoAlpha:0},'+=1.5')
          // .to('#animation',{duration:1,x:20,y:18,yoyo:true,repeat:1,repeatDelay:(1.3)},'-=2')
          // .staggerFrom(["#txt_4","#txt_5"],0.5,{autoAlpha:0,ease: 'sine.in'},0.2,'-=1.4')
          // .from("#pack_1",0.5,{autoAlpha:0},'-=0.2')
          // .to("#pack_1",0.5,{scale:1.11,scaleY:0.9,yoyo:true,repeat:1},'-=0.4')
          // .add("packs")
          // .from("#pack_2",0.5,{autoAlpha:0,x:-30,scale:1.1},"packs-=0.4")
          // .from("#pack_3",0.5,{autoAlpha:0,x:30,scale:1.1},"packs-=0.4")
          // .from("#cta",0.5,{autoAlpha:0,y:10},'-=0.5')
          // .from('#animation',{duration:animTime,backgroundPosition: "100%",ease:"steps(7)",yoyo:true,repeat:1,repeatDelay:(1.3)},"animate")
