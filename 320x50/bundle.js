    ...
    init: function init() {
      ...
      function display() {
        ...
        function animation() {
          ...
          //
          // .to(["#txt_3,#txt_4"],1,{autoAlpha:0},'+=0.5')
          // .from("#pack_1",0.5,{autoAlpha:0})
          // .to("#pack_1",0.5,{scale:1.04,scaleY:0.9,yoyo:true,repeat:1},'-=0.4')
          // .add("packs")
          ...
          .from('#animation', {
            ...
            duration: 0.4,
            autoAlpha: 0
          }, '+=0.4').staggerFrom(["#txt_1", "#txt_2"], 1, {
            autoAlpha: 0,
            ease: 'sine.in'
          }, 0.2).to(["#txt_1,#txt_2"], 1, {
            autoAlpha: 0
          }, '+=0.5').staggerFrom(["#txt_3", "#txt_4"], 1, {
            autoAlpha: 0,
            ease: 'sine.in'
          }, 0.2).to(["#txt_3,#txt_4"], 1, {
            autoAlpha: 0
          }, '+=0.5').from("#pack_1", 0.5, {
            autoAlpha: 0
          }).to("#pack_1", 0.5, {
