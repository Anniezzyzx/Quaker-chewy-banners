    ...
    init: function init() {
      ...
      function display() {
        ...
        function animation() {
          ...
          tl // .staggerFrom(["#txt_1","#txt_2"],1,{autoAlpha:0,ease: 'sine.in'},0.2)
          // .to(["#txt_1,#txt_2"],1,{autoAlpha:0},'+=0.5')
          // .staggerFrom(["#txt_3","#txt_4"],1,{autoAlpha:0,ease: 'sine.in'},0.2)
          // .from("#pack_1",0.5,{autoAlpha:0},'-=0.8')
          // .to("#pack_1",0.5,{scale:1.11,scaleY:0.9,yoyo:true,repeat:1},'-=0.7')
          // .add("packs")
          ...
          .staggerFrom(["#txt_1", "#txt_2"], 0.5, {
            autoAlpha: 0,
            ease: 'sine.in'
          }, 0.2).add("animate").to(["#txt_1,#txt_2"], 0.5, {
            autoAlpha: 0
          }, '+=1.5').to("#animation", 0.5, {
            autoAlpha: 0
          }, '-=0.5').to('#animation', {
            duration: 0.5,
            x: 10,
            y: 3,
            scale: 0.6
          }, '-=1.6') // .to('#animation',{duration:0.5,y:5},'-=1.5')
          .staggerFrom(["#txt_3", "#txt_4"], 0.5, {
            autoAlpha: 0,
            ease: 'sine.in'
          }, 0.2).from("#pack_1", 0.5, {
            autoAlpha: 0
            ...
            yoyo: true,
            repeat: 1
          }, '-=0.7').add("packs").from("#pack_2", 0.5, {
            autoAlpha: 0,
            x: -30,
            scale: 1.1
          }, "packs-=0.5").from("#pack_3", 0.5, {
            autoAlpha: 0,
            x: 30,
            scale: 1.1
          }, "packs-=0.5").from("#cta", 0.5, {
            autoAlpha: 0,
            y: 10
          }, '-=0.7').from('#animation', {
            duration: animTime,
